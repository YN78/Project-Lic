...
Adodc1.RecordSource = "select * from Customer where Customer_Name  like '" & Combo1.Text & "'"
Adodc1.Refresh
...
rs.Open "delete * from Customer where  Customer_Number=" & id
'rs.Delete
'rs.Update
Adodc1.Refresh
DataGrid1.Refresh
'rs.Close
'Combo1.Refresh
rs1.Open "select * from Customer", con, 2, 2
...
Adodc1.RecordSource = "select Customer_Name from customer"
